...
class DeclutterSwipeStack extends StatefulWidget {
  ...
  ///
  /// This field is only considered when initializing an [DeclutterSwipeStack].
  ...
  /// is triggered by [DeclutterSwipeController].
...
class _DeclutterSwipeStackState extends State<DeclutterSwipeStack> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final int backgroundIndex =
        _swipeActivity is Unswipe ? foregroundIndex : (foregroundIndex + 1) % widget.cardCount;
...
/// A controller used to control an [DeclutterSwipeStack],
///
...
class DeclutterSwipeController extends ChangeNotifier {
  ...
  ///
  /// The default direction is set by the attached [DeclutterSwipeStack] widget.
...
/// the swiper state.
///
/// The swiper position is exposed by [DeclutterSwipeController].
class SwiperPosition with ChangeNotifier {
  ...
  /// [DeclutterSwipeStack.maxAngle] when [progress] is 1.
  ///
  ...
  /// [DeclutterSwipeStack.loop] is true, this will wrap to 0 at the end of the card
  ...
  void _updateFromWidgetState(DeclutterSwipeStack widget) {
